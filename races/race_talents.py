...
class Talent(Enum):
    ...
    ENEMIES = {"Enemies": "Dwarves are natural enemies and compete for territory with orcs, ogres, and hobgoblins; therefore, attacks by dwarves against these creatures are considered easy attacks."}
    ...
    LARGE_WEAPONS = {"Large Weapons": "Restricted for dwarves, who can only use medium and small weapons. Large weapons forged as a dwarven racial item are considered medium weapons for a dwarf."}
    ...
    STURDY = {"Sturdy": "Dwarves are highly resistant to effects that affect their bodies, receiving a +1 bonus on any Constitution Saving Throw."}
