...
class Mage(Klass):
    ...
    def abilities(self) -> dict:
        return {
            "Arcane Spells": "A Mage is able to cast arcane spells daily. To memorize them, the Mage must study their spellbook, the grimoire, and decide which spells will be memorized for that day. [Grimoire, Initial Spells, New Spells, Upper Circles]",
            "Read Magic": "Once per day per level, the Mage can decipher and read magical inscriptions anywhere, even if they do not understand the message they convey.",
            "Detect Magic": "Once per day per level, the Mage can sense the presence of magic in places, people, or objects within an area of up to 9 meters plus 3 meters per level, provided they are focused and actively searching for it."
        }
